import os
from MyTools import load_corpus, load_word_list, load_word2vec_embeddings, build_vocabulary
...
def forward_pass(qc_data : list[QuantumCircuit], param:ParameterVector, param_values : np.ndarray, nshots : int, sim : AerSimulator):
    ...
    for idx, qc in enumerate(tr_qc):
        ...
        for outcome in measurements:
            # OJO!: el ::-1 es por little endian, no sé si hay que dejarlo o quitarlo.
            # Es que siempre me pasa lo mismo con qiskit...
