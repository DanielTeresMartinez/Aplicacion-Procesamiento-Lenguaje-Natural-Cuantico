...
de qubits de las que se disponía hacía que fuera difícil implementar algoritmos cuánticos.
...
Una vez entendido los fundamentos explicados en este capítulo, se dispone ya del conocimiento necesario para abordar el estado del arte de las técnicas de representación de palabras. El siguiente capítulo profundiza en los modelos concretos que hacen posible convertir palabras en vectores, comenzando por los \textit{word embeddings} clásicos y avanzando hasta las dos arquitecturas centrales de este trabajo que son Word2Vec y su reciente equivalente cuántico desarrollado, QWord2Vec.
