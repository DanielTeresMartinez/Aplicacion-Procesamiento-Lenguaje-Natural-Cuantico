...
Para responder a la segunda cuestión, se deben explorar \textbf{métricas de distancia} específicas que sean efectivas en espacios de tantas dimensiones. Para la primera, es necesario analizar el papel de la \textbf{información latente} \cite{henner_intuitive_embeddings_2023}, la cual permite pasar de representaciones dispersas a vectores densos basados en atributos ocultos.
