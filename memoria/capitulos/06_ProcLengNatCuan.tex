...
A pesar de ello, hubo una emoción muy grande con lo que se podría hacer con estos nuevos ordenadores llamados \glsentrytext{nisq}. Estos nuevos ordenadores tenían entre 50 y 100 \glsentryplural{qubit}, lo que les permitía sobrepasar en rendimiento a los mejores superordenadores clásicos en algunas áreas matemáticas (METER REFERENCIAS 7 Y 8 DEL PDF DOWNLOADS/1880487.pdf).

Los \glsentrytext{cvc} nacieron como la mejor estrategia para hacer frente a los ordenadores \glsentrytext{nisq}. Debido a las limitaciones de estos dipsositivos, se utilizó la estrategia de optimización basado en el aprendizaje. Es decir, no son más que una analogía cuántica a los técnicas existentes del campo de \glsentrytext{ml} como pueden ser las redes neuronales.
