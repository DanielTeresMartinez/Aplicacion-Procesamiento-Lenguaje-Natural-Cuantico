...
FINAL_EPOCHS = 500
PRINT_EVERY = 50
LOSS_FILE = "data/loss_history_word2vec.txt"
...
if __name__ == "__main__":
    ...
    sentences = list(LineSentence("data/smallCorpora.txt"))
    ...
    fig1.tight_layout()
    if CREATE_IMAGES:
        fig1.savefig("images/lossCurvesWord2Vec.png", dpi=150)
        shutil.copy(
            "images/lossCurvesWord2Vec.png",
            "../../memoria/imagenes/lossCurvesWord2Vec.png",
        )
    ...
    fig2.tight_layout()
    if CREATE_IMAGES:
        fig2.savefig("images/embeddingsWord2Vec.png", dpi=150)
        shutil.copy(
            "images/embeddingsWord2Vec.png",
            "../../memoria/imagenes/embeddingsWord2Vec.png",
        )

    orig_embs = {w: model.wv[w] for w in vocab}
    _save_embeddings(
        "data/word2vec_embeddings.txt",
        orig_embs,
